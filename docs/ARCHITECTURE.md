...
Do not edit the SVG by hand. After refreshing `.maritime/dependency-graph.json`, regenerate the diagram with `npx @dependency-maritime/cli graph --input .maritime --output docs/images/dependency-graph.svg`.
