...
| Donut hunts with and feeds/trains Mongo until the bond completes late on Floor 2. | Corroborating; Pets & Dungeon Familiars reference, Story. | `evt-f2-mongo-acquired`, `evt-f2-mongo-hostility-changed`, and `evt-f2-mongo-bonded` express acquisition, hostility removal, and bonding. | Modeled under typed Pet domain contract. |
